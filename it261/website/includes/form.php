...
<fieldset>
    ...
    <ul>
        <li>
            <input type="checkbox" name="services[]" value="webdesign" <?php
            if(isset($_POST['services']) && in_array('webdesign', $services)){
                echo 'checked="checked"';
            }
            ?>>Website Design
        </li>
        <li>
            <input type="checkbox" name="services[]" value="land" <?php
            if(isset($_POST['services']) && in_array('land', $services)){
                echo 'checked="checked"';
            }
            ?>>Landing Page  
        </li>
        <li>
            <input type="checkbox" name="services[]" value="ecomere" <?php
            if(isset($_POST['services']) && in_array('ecomere', $services)){
                echo 'checked="checked"';
            }
            ?>>E-commerce Website
        </li>
        <li>
            <input type="checkbox" name="services[]" value="host" <?php
            if(isset($_POST['services']) && in_array('host', $services)){
                echo 'checked="checked"';
            }
            ?>>Hosting a Website
        </li>
